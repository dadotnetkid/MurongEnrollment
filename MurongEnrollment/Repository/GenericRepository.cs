...
namespace MurongEnrollment
{
    ...
    {
        private EnrollmentEntities context;
        internal DbSet<TEntity> dbSet;

        public GenericRepository(EnrollmentEntities context)
        {
        ...
        public virtual IQueryable<TEntity> Fetch<TProperty>(params Expression<Func<TEntity, TProperty>>[] includeProperties)
        {
            IQueryable<TEntity> query = dbSet;
